...
public class SerialMain {
	...
	public static void main(String[] args) {
		...
		List<BankMarketing> train = loader.load("ch2-nearest-neighbors-benchmark/data/bank.data");
		System.out.println("Train: " + train.size());
		List<BankMarketing> test = loader.load("ch2-nearest-neighbors-benchmark/data/bank.test");
